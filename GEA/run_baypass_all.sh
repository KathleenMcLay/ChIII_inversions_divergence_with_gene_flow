...
dir="/QRISdata/Q6656/chapter_III/GEA/all"
...
#/home/uqkmcla4/i_baypass -npop 10 -gfile ${dir}/sf8_final_GEA_pops_filtered_SNPs_03.baypass -efile ${dir}/GEA_soil_data.txt -omegafile ${dir}/popcov_mat_omega.out -outprefix ${dir}/all_soilGEA -nthreads 20
...
#/home/uqkmcla4/i_baypass -npop 10 -gfile ${dir}/G.sf8_final_GEA_pops_10kb.pod -efile ${dir}/GEA_soil_data.txt -omegafile ${dir}/popcov_mat_omega.out -outprefix ${dir}/pod_soilGEA -nthreads 20
...
paste "all_chrom.txt" "sf8_final_GEA_pops_filtered_SNPs_03.baypass" > "positions_sf8_final_GEA_pops_filtered_SNPs_03.baypass"

# Run BayPass under the standard covariate model - INVERSIONS as biallelic loci 
# /home/uqkmcla4/i_baypass -npop 10 -gfile ${dir}/inversion_genotypes.baypass -efile ${dir}/GEA_soil_data.txt -omegafile ${dir}/popcov_mat_omega.out -outprefix ${dir}/inversions_soilGEA -nthreads 20
